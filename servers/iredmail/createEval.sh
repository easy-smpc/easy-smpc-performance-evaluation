...
cd /root/easy-smpc
/opt/jdk-14.0.2/bin/java -Dlog4j2.configurationFile=org/bihealth/mi/easysmpc/performanceevaluation/log4j2.xml -jar easy-smpc-performance-evaluation-1.0.jar